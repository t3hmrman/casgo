...
func TestFindUserByEmail(t *testing.T) {
	...
	if casErr != nil {
		...
		t.Logf("Failed to load JSON fixture: %s", casErr.msg)
	}
...
func TestAddNewUser(t *testing.T) {
	...
	if casErr != nil {
		if casErr.err != nil {
			t.Errorf("DB Error: %v", *casErr.err)
		}
...
func addTicketForService(s *CAS, t *testing.T) (*CASTicket, *CASService, *CASServerError) {
	...
	if casErr != nil {
		t.Errorf("Failed to setup tickets table", casErr)
...
func TestFindTicketByIdForService(t *testing.T) {
	...
	if casErr != nil {
		if casErr.err != nil {
			t.Errorf("Utility function to add ticket for service failed, err: %v", *casErr.err)
		}
